...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://tools.sariel.pl/common/styles/navbarfix.css?v=1">
    <link rel="stylesheet" href="http://tools.sariel.pl/common/styles/darktheme.css"/>
  </head>
  <body class="h-100">
    <script src="http://tools.sariel.pl/common/scripts/darktheme.js"></script>
          ...
          <div class="main-navbar sticky-top bg-white">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
              ...
              <div class="show navbar-collapse border-left" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item">
                    <div class="custom-control custom-toggle small"><script src="http://tools.sariel.pl/common/scripts/darkswitch.js"></script></div>
                  </li>
                </ul>
